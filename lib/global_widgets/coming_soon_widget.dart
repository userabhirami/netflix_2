...
class ComingSoonScreenWidget extends StatelessWidget {
  ...
  const ComingSoonScreenWidget(
      {super.key, required this.ComingSoonImage, required this.title});
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                image:
                    DecorationImage(image: ComingSoonImage, fit: BoxFit.fill),
                color: Colors.red,
              ), ///////////
            ),
            SizedBox(
              ...
              children: [
                Column(
                  children: [
                    IconButton(
                      onPressed: () {},
                      icon: Image.asset("assets/images/bi_bell-fill.png"),
                      color: Colors.white,
                    ),
                    Text(
                      "Remind Me",
                ...
                Column(
                  children: [
                    IconButton(
                      onPressed: () {},
                      icon: Image.asset("assets/images/bx_bxs-share-alt.png"),
                      color: Colors.white,
                    ),
                    Text(
                      "Share",
